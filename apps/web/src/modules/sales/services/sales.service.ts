...
import { getSalesCustomers } from "../../../integrations/customer";
...
/**
 * Fetch sales customers via the Anti-Corruption Layer customer integration.
 * 
 * ARCHITECTURAL RATIONALE:
 * Routes sales customer requests directly to the unified Contact Registry,
 * enforcing Rule #6 (Respect Global Entities) and eliminating duplicate customer data stores.
 */
