    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="mt-2 text-[var(--nebula-text-secondary)]">
          Manage the chart of accounts, journal entries, fiscal period locks, and the general ledger.
      ...
      <section id="accounting-periods" className="space-y-4">
        <h2 className="text-xl font-semibold">Fiscal Periods & Governance Locks</h2>
      ...
      <section id="accounting-revaluation" className="space-y-4">
        <h2 className="text-xl font-semibold">Multi-Currency Revaluation</h2>
