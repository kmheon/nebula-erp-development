 ...
 * 
 * ARCHITECTURAL NOTE: Event payloads must reuse canonical entities and types 
 * (such as ContactType and ContactRole) from the Shared Kernel to prevent vocabulary drift.
 */

import type { ContactType, ContactRole } from "../entities/contact.types";
 ...
 * Reuses canonical ContactType and ContactRole definitions from the Shared Kernel.
 */
